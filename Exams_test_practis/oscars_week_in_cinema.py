...
film_name = input()  # Име на филма
hall_type = input()  # Тип на залата
number_of_tickets = int(input())  # Брой закупени билети

# Определяне на цената за билет според филма и залата
ticket_price = 0
...
total_income = number_of_tickets * ticket_price
